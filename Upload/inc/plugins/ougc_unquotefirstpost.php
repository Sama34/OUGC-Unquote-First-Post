...
function ougc_unquotefirstpost_activate()
{
    ...
    // Add our settings
    $PL->settings(
        'ougc_unquotefirstpost',
        $lang->setting_group_ougc_unquotefirstpost,
        $lang->setting_group_ougc_unquotefirstpost_desc,
        array(
            'type' => array(
...
function ougc_unquotefirstpost_deactivate()
{
    ...
    flash_message(
        $lang->sprintf($lang->ougc_unquotefirstpost_pluginlibrary_error, $info['pl']['url'], $info['pl']['version']),
        'error'
    );
...
function ougc_unquotefirstpost_postbit(&$post)
{
    ...
    if (!is_member($mybb->settings['ougc_unquotefirstpost_groups']) || !is_member(
            $mybb->settings['ougc_unquotefirstpost_forums'],
            array('usergroup' => $thread['fid'])
        )) {
